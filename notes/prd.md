# Product Requirements Document — Praxis (working codename)
...
> "Praxis" is a placeholder name. It means putting knowledge into practice, which is the whole thesis of the product: the MCAT grades application, so the app has to train application, not just recall.
