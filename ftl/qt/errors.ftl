...
errors-standard-popup2 =
    Synapse encountered a problem. Please follow the troubleshooting steps.
...
errors-addons-active-popup =
    ...
    An error occurred. Please start Synapse while holding down the shift key,
    ...
    Tools > Add-ons menu item to disable some add-ons and restart Synapse,
...
errors-accessing-db =
    ...
    interfering with Synapse. Try disabling such software and see if the
    problem goes away.
    - Your disk may be full.
    - The Documents/Synapse folder may be on a network drive.
    - Files in the Documents/Synapse folder may not be writeable.
    - Your hard disk may have errors.
    
    It's a good idea to run Tools>Check Database to ensure your collection is not corrupt.
errors-unable-open-collection =
    Synapse was unable to open your collection file. If problems persist after restarting your computer, please use the Open Backup button in the profile manager.
