...
preferences-changes-will-take-effect-when-you = Changes will take effect when you restart Synapse.
...
preferences-media-is-not-backed-up = Media is not backed up. Please create a periodic backup of your Synapse folder to be safe.
...
preferences-please-restart-anki-to-complete-language = Please restart Synapse to complete language change.
...
preferences-some-settings-will-take-effect-after = Some settings will take effect after you restart Synapse.
...
preferences-backup-explanation =
    Synapse periodically backs up your collection. After backups are more than 2 days old,
    Synapse will start removing some of them to free up disk space.
...
preferences-third-party-description = Third-party services are unaffiliated with and not endorsed by Synapse. Use of these services may require payment.
