...
sync-conflict = Only one copy of Synapse (Anki) can sync to your account at once. Please wait a few minutes, then try again.
sync-server-error = AnkiWeb encountered a problem. Please try again in a few minutes.
sync-client-too-old = Your Synapse (Anki) version is too old. Please update to the latest version to continue syncing.
...
sync-must-wait-for-end = Synapse is currently syncing. Please wait for the sync to complete, then try again.
...
sync-conflict-explanation =
    ...
    If you choose download, Synapse will fetch the collection from AnkiWeb, and any changes you have made on this device since the last sync will be lost.
    
    If you choose upload, Synapse will send this device's data to AnkiWeb, and any changes that are waiting on AnkiWeb will be lost.
